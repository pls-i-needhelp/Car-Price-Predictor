...
def main(x=None):
    ...
    seller_type = st.selectbox("Select Type of Saling Option:", ["Individual", "Dealer", "Trustmark Dealer"])
    ...
    mileage = st.number_input("Enter the Mileage (kmpl)", min_value=1, max_value=100, value=20)
    ...
    engine = st.number_input("Enter the Engine Power (CC)", max_value=3000)
